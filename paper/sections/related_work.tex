...
semantic entropy inherits exactly this pathology, with the twist that the granularity limit is
set by the sampling budget rather than by a verbalisation format; our contribution here is the
instantiation and its consequence for attack evaluation, not the argument itself. The
...
sharper and the narrower of our two, and we keep the two apart wherever we make them. Read
