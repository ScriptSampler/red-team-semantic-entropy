...
$\log N$, and in deployment it piles up there---which is not a competing claim but a
mechanism for theirs: a statistic capped at $\log N$ must understate whenever the quantity it
estimates is larger. Separately, \citet{sun2026granularity} name the \emph{score granularity
