...
two top-decile points and the $0.139$ nats between them, the unwinnable share of the
false-alarm denominator, the exact-saturation counts, and the hard-tie handling in the
exceedance test all presuppose integer cluster sizes and lapse under real-valued weights.
