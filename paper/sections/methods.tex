...
adjudicate. We therefore specify a victim- and NLI-independent LLM-judge equivalence
oracle, validated on the same labelled pairs, as the instrument required to attribute the
effect; absent it, attribution is reported as an explicit bracket rather than a claim.
