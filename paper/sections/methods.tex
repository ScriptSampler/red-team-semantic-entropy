...
no upward move was ever possible), whereas no hide target reaches the floor---though that
last comparison is on a partial hide cell and we restate it when that cell completes.
