...
hard-negative accuracy $0.92$ where the embedder is near-chance ($0.51$). Re-clustering
the answer samples under this validated judge, a preliminary $n{=}6$ machinery-validation
pass indicates the attack's effect \emph{largely survives} the independent oracle: the
