...
leave an operator only a handful of usable thresholds. We count that argument out for
...
\emph{points}, not a curve, and the finite achievable set they form grows with the sample.
The dashed line is the upper convex hull, reachable only by a rule that
...
question $N$ different ways. That frequency is a property of the model and the question
distribution, not of
...
$0.0\%$ [$0.0$, $1.9$] and the floor becomes an ordinary order statistic. That statistic is
the four
