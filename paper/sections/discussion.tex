...
includes zero, and its per-target statistics are quantised too coarsely to order the
clusterer arms at all (Methods), so we quote no point estimate from it and draw no reading
