...
falls under the line rather than over it (Section~\ref{sec:discussion}). The claim is about
...
protocol supports, and on the evidence it returned that is no attack effect. In every
clustering arm, and at every one of $101$ tie-break draws, the pre-committed exceedance test
fails to reject, and the median observed exceedance count sits above its null expectation
