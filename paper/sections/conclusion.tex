...
detector itself, and found it does not hold: a meaning-preserving paraphrase---verified
equivalent by bidirectional NLI, leaving the model's correctness unchanged---can move a
detector's score in either direction, including the under-explored direction that turns
a correct answer into a false alarm. We were careful to make this claim only where the
