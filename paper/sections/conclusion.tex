...
victim- and NLI-independent LLM-judge, validated on exactly that case, preliminarily
indicates the effect survives---evidence the vulnerability is real rather than a
clustering artifact---which the confirmatory large-$n$ run is set to settle. Second,
