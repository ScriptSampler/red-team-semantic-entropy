...
% independently of both reports before being written here; the two agree.
...
also the targets for which the optimiser found no feasible paraphrase. Bands are mean intended
...
Exceedances $S$: observed / expected     & $30$ / $20.4$ & $383$ / $20.4$ & $636$ / $20.4$ \\
...
negative on $10$ of $77$ targets under NLI. The paired net therefore credits the attack with
...
its null expectation in all three arms ($30$, $383$ and $636$ against $20.4$), which is the
direction \emph{against} the attack, so the statistic does not sit ambiguously near the cut. In
...
population}, not that none exists. The same discipline governs the supplementary intervals:
the exact-match net covers zero and is reported as covering zero, not as null.
...
$250$ feasibility attempts was rejected, and they are the same three for which the optimiser
found no feasible paraphrase either---joint evidence that no feasible paraphrase of those
questions exists, rather than that the sampler was unlucky. They are excluded and stated, never
absorbed into a denominator of $80$. Six further arms are short; the resulting inflation of the
...
defensible reading of the adjudicator arm is null}: at this $n$, on this population, and with
the comparator matched, we cannot distinguish the optimised attack from a budget-matched benign
